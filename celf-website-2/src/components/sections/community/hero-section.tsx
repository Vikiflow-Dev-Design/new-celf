...
import { ArrowRight, Users, Heart, Globe, MessageCircle, Award, Star } from "lucide-react";
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-gray-300 font-medium">Global Student Community</span>
          </motion.div>
          ...
          >
            Connect with thousands of students worldwide who are mining tokens, sharing knowledge, 
            and supporting each other on their educational journeys.
          </motion.p>
          ...
          >
            <div className="flex flex-col items-center space-y-3 text-gray-300 bg-gray-900/50 rounded-xl p-6 border border-[#9EFF00]/20">
              ...
              <span className="font-medium text-center text-sm">Active Members</span>
            </div>
            <div className="flex flex-col items-center space-y-3 text-gray-300 bg-gray-900/50 rounded-xl p-6 border border-[#9EFF00]/20">
              <div className="w-12 h-12 bg-gradient-to-br from-[#9EFF00]/20 to-[#9EFF00]/5 rounded-xl flex items-center justify-center mb-2">
              ...
              <span className="font-medium text-center text-sm">Countries</span>
            </div>
            <div className="flex flex-col items-center space-y-3 text-gray-300 bg-gray-900/50 rounded-xl p-6 border border-[#9EFF00]/20">
              <div className="w-12 h-12 bg-gradient-to-br from-[#9EFF00]/20 to-[#9EFF00]/5 rounded-xl flex items-center justify-center mb-2">
                <MessageCircle className="h-6 w-6 text-[#9EFF00]" />
              </div>
              <div className="text-2xl font-bold text-[#9EFF00]">10K+</div>
              <span className="font-medium text-center text-sm">Daily Messages</span>
            </div>
            <div className="flex flex-col items-center space-y-3 text-gray-300 bg-gray-900/50 rounded-xl p-6 border border-[#9EFF00]/20">
              <div className="w-12 h-12 bg-gradient-to-br from-[#9EFF00]/20 to-[#9EFF00]/5 rounded-xl flex items-center justify-center mb-2">
              ...
              <span className="font-medium text-center text-sm">Success Stories</span>
            </div>
          </motion.div>
          ...
          >
            <Button size="xl" asChild>
              <Link href="#join-community" className="group">
                Join Community
          ...
          >
            <div className="text-center">
              <div className="text-lg font-bold text-[#9EFF00] mb-1">24/7 Support</div>
              <div className="text-gray-400 text-sm">Always someone online to help</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-[#9EFF00] mb-1">Peer Mentorship</div>
              <div className="text-gray-400 text-sm">Learn from successful students</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-[#9EFF00] mb-1">Global Network</div>
              <div className="text-gray-400 text-sm">Connect across continents</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <blockquote className="text-lg text-gray-300 italic leading-relaxed mb-4">
              "The CELF community changed my life. Not only did I earn enough tokens for a scholarship, 
              but I found lifelong friends and mentors who supported me every step of the way."
            </blockquote>
            <div className="text-center">
              <div className="font-semibold text-white">Maria Rodriguez</div>
              <div className="text-sm text-gray-400">Computer Science Student • Spain</div>
              <div className="text-xs text-[#9EFF00] mt-1">$15,000 Scholarship Recipient</div>
            </div>
          </motion.div>
