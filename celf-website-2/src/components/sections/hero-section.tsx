...
import { ArrowRight, Coins, GraduationCap, Users } from "lucide-react";
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#0A0A0A] via-[#2A2A2A] to-[#0A0A0A]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-radial from-[#9EFF00]/20 to-transparent rounded-full blur-3xl"
        />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-[#9EFF00] drop-shadow-[0_0_30px_rgba(158,255,0,0.5)]">
          ...
          >
            Mine CELF tokens and qualify for educational scholarships. Join the
            future of decentralized education funding.
          </motion.p>
          ...
          >
            ...
            <Button variant="secondary" size="xl" asChild>
              <Link href="/what-is-celf">Learn More</Link>
            </Button>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-center space-x-3 text-text-secondary">
              <div className="w-10 h-10 bg-card-glow rounded-celf-md flex items-center justify-center">
                <Coins className="h-5 w-5 text-brand-primary" />
              </div>
              <span className="font-medium">Mine CELF Tokens</span>
            </div>
            <div className="flex items-center justify-center space-x-3 text-text-secondary">
              <div className="w-10 h-10 bg-card-glow rounded-celf-md flex items-center justify-center">
                <GraduationCap className="h-5 w-5 text-brand-primary" />
              </div>
              <span className="font-medium">Earn Scholarships</span>
            </div>
            <div className="flex items-center justify-center space-x-3 text-text-secondary">
              <div className="w-10 h-10 bg-card-glow rounded-celf-md flex items-center justify-center">
      ...
      >
        <motion.div
          ...
          className="w-6 h-10 border-2 border-border-accent rounded-full flex justify-center"
        >
          <motion.div
            animate={{ y: [0, 12, 0] }}
            transition={{ duration: 2, repeat: Infinity }}
